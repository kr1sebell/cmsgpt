...
define('OPENAI_PROXY', isset($ENV['OPENAI_PROXY']) ? $ENV['OPENAI_PROXY'] : '');
define('OPENAI_PROXY_AUTH', isset($ENV['OPENAI_PROXY_AUTH']) ? $ENV['OPENAI_PROXY_AUTH'] : '');
define('OPENAI_PROXY_TYPE', isset($ENV['OPENAI_PROXY_TYPE']) ? strtolower($ENV['OPENAI_PROXY_TYPE']) : '');
